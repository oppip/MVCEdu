        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
            using (var context = new MVCEduContext(serviceProvider.GetRequiredService<DbContextOptions<MVCEduContext>>()))
            {
                ...
                context.Teacher.AddRange(
                    ...
                    new Teacher { /*Id = 6,*/ FirstName = "Перо",          LastName = "Латковски",    AcademicRank = "Професор",             Degree = "PhD",   HireDate = DateTime.Parse("2015-1-6"), OfficeNumber = "1006" },
                ...
                context.Course.AddRange(
                    ...
                    new Course { /*Id = 5,*/ Title = "Оптички мрежи",   Credits = 7, Semester = 4, Programme = "ТКИИ",          EducationLevel = "2", FirstTeacherId = context.Teacher.Single(d => d.FirstName == "Борислав" && d.LastName == "Поповски").Id,   SecondTeacherId = context.Teacher.Single(d => d.FirstName == "Перо" && d.LastName == "Латковски").Id }
                    );
                context.SaveChanges();
